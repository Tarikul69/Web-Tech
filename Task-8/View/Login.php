...
<html>
  ...
  <body class="col-12">
    ...
    <div class=""> 
      ...
      <div  class="center" >
       ...
       <div id="login" >
         ...
         <form class="col" name="form" method="post" onsubmit="return ValidationEvent()" action="Dashboard.php">
           Name
           <br>
    ...
    {
       if(login['pass'].value.length >= 3 )
       {
               // alert("good");
       }else{
        document.getElementById("message1").innerHTML = "Password is empty.";
       }
       ...
       // console.log("Bad");
        //alert("Invalid Email");
         document.getElementById("message").innerHTML = "Wrong Email.";
        //var abc = "Wrong Email Address.";
    }
 }
      </script>
  </body>
